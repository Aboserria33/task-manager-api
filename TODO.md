# Task Manager API — Flask Rebuild TODO

## Steps
- [x] Create Flask project structure (app.py, database.py, requirements.txt, .gitignore)
- [x] Update README.md for Flask setup/usage
